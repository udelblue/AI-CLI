...
def main():
    ...
    parser.add_argument(
        ...
        required=False, 
        default=None,
        choices=["gpt-4", "gpt-4-0314", "gpt-4-32k", "gpt-4-32k-0314", "gpt-4-32k-0613", "gpt-3.5-turbo", "gpt-3.5-turbo-16k", "gpt-3.5-turbo-0301", "gpt-3.5-turbo-0613", "gpt-3.5-turbo-1106", "text-davinci-003", "code-davinci-002", "text-davinci-001", "text-curie-001", "text-babbage-001", "text-ada-001"],
